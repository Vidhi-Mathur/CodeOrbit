...
export const ProfileForm = ({mode, onSubmit, initialData = initialFormData, isFetching = false}: ProfileFormProps) => {
    ...
    const [formData, setFormData] = useState<FormDataInterface>(initialData)
                ...
                <div className="w-full lg:w-3/4 bg-gradient-to-br from-blue-50 to-blue-100 overflow-y-auto scrollbar-hide">
                    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10">
                        <div className="mb-6 lg:mb-8">
                            <h1 className="text-2xl sm:text-3xl font-bold text-blue-900">{mode === "create"? "Create": "Update"} Your Developer Profile</h1>
                            <p className="text-blue-700 mt-2 text-sm sm:text-base">
                                Complete all steps to {mode === "create"? "set up": "modify"} your professional profile
                            </p>
                        </div>
                        {error && (
