...
export const dsaLinks: string[] = ["leetcode", "geeksforgeeks", "codeforces", "codechef", "hackerrank", "interviewbit", "codingninjas"] as const 
export type DsaLink = typeof dsaLinks[number];
