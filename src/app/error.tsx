  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
            <Image src="/bg/error.png" alt="Page not found" fill className="object-cover" priority/>
        ...
        <div className="relative z-10 text-center px-4 max-w-md">
            <h1 className="text-9xl font-black mb-4">
                <span className="inline-block bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">500</span>
            </h1>
